	...
	exports.autocompletes = {
		"Function": {
			...
			"checkcaller()": {
				...
				"documentation": {
					value: [
						...
						"",
						"Returns whether the calling thread was created by Nihon.",
					].join("\n")
				},
			},
			...
			"clonefunction()": {
				...
				"documentation": {
					value: [
						"```lua", "function clonefunction()\n  -> clone: function", "```",
						"",
						"Returns the cloned function created.",
					].join("\n")
				},
			},
			...
			"replaceclosure()": {
				...
				"documentation": {
					value: [
						"```lua", "function replaceclosure(f: function, hook: function))\n  -> original: function", "```",
						"",
						"Redirects calls to `f` with `hook` and returns the original function.",
					].join("\n")
				},
			...
			"isexecutorclosure()": {
				...
				"documentation": {
					value: [
						...
						"",
						"Returns whether the closure is nihon's closure."
					].join("\n")
				},
			},
			"checkclosure()": {
				...
				"documentation": {
					value: [
						"```lua", "function checkclosure(f: function)\n  -> boolean", "```",
						"",
						"Returns whether the closure is nihon's closure."
					].join("\n")
				},
			...
			"isourclosure()": {
				"insertText": "isourclosure(${1:f})",
				"documentation": {
					value: [
						"```lua", "function isourclosure(f: function)\n  -> boolean", "```",
						"",
						"Returns whether the closure is nihon's closure."
					].join("\n")
				},
			...
			"islclosure()": {
				...
				"documentation": {
					value: [
						...
						"",
						"Returns whether the closure is a LClosure."
					].join("\n")
				},
			},
			"iscclosure()": {
			...
			"keypress()": {
				...
				"documentation": {
					value: [
						"```lua", "function keytap(keyCode: KeyCode)", "```",
						"",
						"Virtually taps a key.",
					].join("\n")
				},
			},
			...
			"isgameactive()": {
				"insertText": "isgameactive()",
				"documentation": {
					value: [
						"```lua", "function isgameactive()\n  -> boolean", "```",
						"",
						"Returns whether the Roblox window is active.",
					].join("\n")
				},
			...
			"hookmetamethod()": {
				"insertText": "hookmetamethod(${1:table}, \"${2:method}\", ${3:function})",
				"documentation": {
					value: [
						"```lua", "function hookmetamethod(object: table, method: string, hook: function))\n  -> original: metamethod", "```",
						"",
						"Redirects calls to `f` with `hook` and returns the original metamethod.",
					].join("\n")
				},
			},
